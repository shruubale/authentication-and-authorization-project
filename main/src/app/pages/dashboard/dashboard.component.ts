...
export class AppDashboardComponent implements OnInit{
  ...
  constructor(private service: MainService, private bannerService: BannerService,) {
  ...
  displayBanners() {
    this.bannerService.getBanners().subscribe((res) => {
      ...
      this.arrResponse = res.filter(
        (banner) => currentDate >= new Date(banner.startDate) && currentDate <= new Date(banner.endDate));
        console.log(this.arrResponse);
